...
#ifndef AVOCADO_BACKEND_BACKEND_DEFS_V2_H_
#define AVOCADO_BACKEND_BACKEND_DEFS_V2_H_
...
//			In this mode, a pointwise first derivative of swish activation of the input tensor is computed.
		...
		/* Opaque type for backend shape descriptor */
		typedef int avShapeDescriptor_t;
...
#endif /* AVOCADO_BACKEND_BACKEND_DEFS_V2_H_ */
