...
namespace avocado
{
	namespace backend
	{
		...
		{
		private:
			avContextDescriptor_t m_desc = AVOCADO_INVALID_DEVICE_INDEX;
			avContextDescriptor_t m_ref_desc = AVOCADO_INVALID_DEVICE_INDEX;
		...
		{
		private:
			avOptimizerDescriptor_t m_desc = AVOCADO_INVALID_DEVICE_INDEX;
			avOptimizerDescriptor_t m_ref_desc = AVOCADO_INVALID_DEVICE_INDEX;
		public:
		...
		public:
			...
			void set(avConvolutionMode_t mode, const std::array<int, 3> &padding, const std::array<int, 3> &strides, const std::array<int, 3> &dilation,
